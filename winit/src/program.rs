    ...
    P::Theme: DefaultStyle,
{
    ...
    let event_loop_builder = {
        ...
        use crate::settings::ActivationPolicy;

        let activation_policy = match settings.platform_specific.activation_policy {
            ActivationPolicy::Regular => winit::platform::macos::ActivationPolicy::Regular,
            ActivationPolicy::Accessory => winit::platform::macos::ActivationPolicy::Accessory,
            ActivationPolicy::Prohibited => winit::platform::macos::ActivationPolicy::Prohibited,
        };

        let activate_ignoring_other_apps = settings
            .platform_specific
